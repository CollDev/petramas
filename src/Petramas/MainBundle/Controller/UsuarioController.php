...
use Petramas\MainBundle\Entity\Usuario;
use Petramas\MainBundle\Form\UsuarioType;
...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PetramasMainBundle:Usuario')->findAll();
     ...
     * @Method("POST")
     * @Template("PetramasMainBundle:Usuario:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PetramasMainBundle:Usuario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PetramasMainBundle:Usuario:edit.html.twig")
     */
